...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.master = master
        master.title('Aplikasi Pengelolaan Stok Barang | nisacodelifings')
        # Width height
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Kode Barang', font=('bold', 14), pady=20)
        ...
        self.customer_label = tk.Label(
            self.master, text='Nama Barang', font=('bold', 14))
        ...
        self.retailer_label = tk.Label(
            self.master, text='Harga Barang', font=('bold', 14))
        ...
        self.price_label = tk.Label(
            self.master, text='Stok Barang', font=('bold', 14))
        ...
        self.add_btn = tk.Button(
            self.master, text="Tambah", width=12, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Hapus", width=12, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update", width=12, command=self.update_item)
